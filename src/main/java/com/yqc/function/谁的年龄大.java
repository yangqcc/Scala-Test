...
public class 谁的年龄大 {
    ...
    public static void main(String[] args) {
        int 张大爷的年龄 = 20;
        int 杨大爷的年龄 = 21;
        boolean 张大爷的年龄是不是比杨大爷的年龄要大 = 判断甲的年龄大还是乙大(张大爷的年龄, 杨大爷的年龄);

        if (张大爷的年龄是不是比杨大爷的年龄要大 == 对) {
            在控制台输出这么一句话并换行("张大爷的年龄大");
        } else if (张大爷的年龄是不是比杨大爷的年龄要大 == 大错特错) {
            在控制台输出这么一句话并换行("杨大爷的年龄大");
        }
    }
